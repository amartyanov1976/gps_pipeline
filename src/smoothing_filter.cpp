...
FilterResult SmoothingFilter::process(GpsPoint& point, const IHistory& history) {
...
void SmoothingFilter::setEnabled(bool enabled) { enabled_ = enabled; }
bool SmoothingFilter::isEnabled() const { return enabled_; }
std::string SmoothingFilter::getName() const { return "SmoothingFilter"; }
void SmoothingFilter::setCutoffFrequency(double freq) { cutoffFrequency_ = freq; }
double SmoothingFilter::getCutoffFrequency() const { return cutoffFrequency_; }
void SmoothingFilter::setSampleRate(double rate) { sampleRate_ = rate; }
double SmoothingFilter::getSampleRate() const { return sampleRate_; }
